...
from src.general import segments2boxes, xywhn2xyxy, xyxy2xywhn, xyn2xy
from src.augmentations import load_image, mixup, letterbox, random_perspective, \
    augment_hsv, pastein, load_samples, Albumentations, copy_paste
    ...
    def __init__(self,
        ...
        try:
            ...
            try:
                ...
                assert cache['hash'] == get_hash(self.label_files + self.img_file)  # identical hash
            except Exception as e:
